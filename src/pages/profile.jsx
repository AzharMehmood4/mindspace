...
function Profile() {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      setProfileImage(imageUrl); // Update image without reload
    }
  };

  // Total meditation time in hours and minutes
  const totalMinutes = completedMeditations.reduce(
            ...
            <label className="absolute bottom-0 right-0 bg-green-600 rounded-full p-1 cursor-pointer hover:bg-green-700">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M15.232 5.232l3.536 3.536M9 11l6 6m-6 0H3v-6l6 6z"
                />
              </svg>
            </label>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="w-full bg-gray-200 h-4 rounded mt-2">
            <div
              ...
              style={{
                width: `${
                  (completedMeditations.length / manifest.length) * 100
                }%`,
              }}
            ></div>
          </div>
